...
export const allItems: CourseItem[] = [
  ...
  },
  {
    id: 'auto-ttk080',
    type: 'Classes',
    title: { en: 'Information Retrieval and Interface', jp: '情報検索とインタフェース' },
    teacher: { en: 'TBD', jp: '未定' },
  ...
  },
  {
    id: 'auto-ttk040',
    type: 'Classes',
    title: { en: 'Telecommunication Network Engineering', jp: '情報通信ネットワーク' },
    teacher: { en: 'TBD', jp: '未定' },
    location: { en: 'TBD', jp: '未定' },
    dayOfWeek: 3,
    periods: [3, 4],
  ...
  },
  {
    id: 'auto-ttk075',
    type: 'Classes',
    title: { en: 'Introduction to Language Processing', jp: '言語処理入門' },
    teacher: { en: 'TBD', jp: '未定' },
    location: { en: 'TBD', jp: '未定' },
    dayOfWeek: 3,
    periods: [3],
  ...
  },
  {
    id: 'auto-ttk025',
    type: 'Classes',
    title: { en: 'Global Business English', jp: 'グローバルビジネス英語' },
    teacher: { en: 'TBD', jp: '未定' },
    location: { en: 'TBD', jp: '未定' },
    dayOfWeek: 3,
    periods: [4],
  ...
  },
  {
    id: 'auto-ttk045',
    type: 'Classes',
    title: { en: 'Artificial Intelligence and Intellectual Control', jp: '人工知能と知的制御' },
    teacher: { en: 'TBD', jp: '未定' },
    location: { en: 'TBD', jp: '未定' },
    dayOfWeek: 4,
    periods: [3],
  ...
  },
  {
    id: 'auto-ttk055',
    type: 'Classes',
    title: { en: 'Data Analysis', jp: 'データ解析' },
    teacher: { en: 'TBD', jp: '未定' },
    location: { en: 'TBD', jp: '未定' },
    dayOfWeek: 4,
    periods: [4],
  ...
  },
  {
    id: 'auto-ttk100',
    type: 'Classes',
    title: { en: 'Smart Society and Human Behavior', jp: 'スマート社会と人間行動' },
    teacher: { en: 'TBD', jp: '未定' },
    location: { en: 'TBD', jp: '未定' },
    dayOfWeek: 5,
    periods: [1],
  ...
  },
  {
    id: 'auto-ttk044',
    type: 'Classes',
    title: { en: 'Machine Learning Fundamentals', jp: '機械学習の基礎' },
    teacher: { en: 'TBD', jp: '未定' },
    location: { en: 'TBD', jp: '未定' },
    dayOfWeek: 5,
    periods: [2],
  ...
  },
  {
    id: 'auto-ttk020',
    type: 'Classes',
    title: { en: 'Business Research', jp: '企業研究' },
    teacher: { en: 'TBD', jp: '未定' },
    location: { en: 'TBD', jp: '未定' },
    dayOfWeek: 2,
    periods: [4],
    ...
    code: 'TTK020',
    credits: 1,
    overview: { en: 'Students learn how to find and analyse companies in their area of interest, studying public corporate information and business models.', jp: '公開されている企業情報やビジネスモデルを学びながら、自身の関心領域における企業を調査・分析する手法を習得します。' }
  },
  {
    id: 'auto-ttk095',
    type: 'Classes',
  ...
  },
  {
    id: 'auto-ttm010',
    type: 'Classes',
    title: { en: 'Glocal PBL', jp: 'グローカルPBL' },
    teacher: { en: 'TBD', jp: '未定' },
    location: { en: 'TBD', jp: '未定' },
    dayOfWeek: 1,
    periods: [5],
  ...
  },
  {
    id: 'auto-ttk050',
    type: 'Classes',
    title: { en: 'Natural Language Processing', jp: '自然言語処理' },
    teacher: { en: 'TBD', jp: '未定' },
    location: { en: 'TBD', jp: '未定' },
    dayOfWeek: 2,
    periods: [4],
