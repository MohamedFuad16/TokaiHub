...
export const allItems: CourseItem[] = [
  ...
  },
  {
    id: 'auto-ttk040',
    type: 'Classes',
    title: { en: 'Telecommunication Network Engineering', jp: '情報通信ネットワーク工学' },
    teacher: { en: 'TBD', jp: '未定' },
    location: { en: 'TBD', jp: '未定' },
    dayOfWeek: 3,
    periods: [2],
  ...
  },
  {
    id: 'auto-ttk020',
    type: 'Classes',
    title: { en: 'Business Research', jp: 'ビジネスリサーチ' },
    teacher: { en: 'TBD', jp: '未定' },
    location: { en: 'TBD', jp: '未定' },
    dayOfWeek: 5,
    periods: [3],
  ...
  },
  {
    id: 'auto-ttk095',
    type: 'Classes',
    title: { en: 'Quality, Reliability and Safety', jp: '品質・信頼性と安全性' },
    teacher: { en: 'TBD', jp: '未定' },
    location: { en: 'TBD', jp: '未定' },
    dayOfWeek: 5,
    periods: [4],
